...
<style>
  ...
  /* general-purpose statistical tools (CART, regression, Cox) — not tied to text/DFM data, so a distinct pastel purple */
  .gallery-grid.sw-stat .gallery-item { border-left: 4px solid #8e5fc9; background: linear-gradient(135deg, #f2ecfa 0%, var(--color-white) 45%); }
  .gallery-grid.sw-stat .gallery-item h3 { color: #6b3fa0; }
  .subsection-title { font-size: 1rem; font-weight: 700; color: var(--color-text); margin: 4px 0 14px; }
</style>
...
<div class="section">
  ...
  <h3 class="subsection-title" data-ja="テキスト・DFM分析">Text &amp; DFM analysis</h3>
