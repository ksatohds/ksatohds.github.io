...
<div class="section">
  ...
  <div class="gallery-grid">
    ...
    <div class="gallery-item">
      <img src="{{ 'image/09a4e126841a01439b266d52236c22fd.jpg' | relative_url }}" alt="非負値行列因子分解(NMF)">
      <div class="gallery-body">
        <h3>■非負値行列因子分解(NMF)</h3>
        <div class="gallery-links">
          <a href="https://doi.org/10.5023/jappstat.52.59">佐藤 (応用統計学,2023)</a>
          <a href="http://arxiv.org/abs/2403.05359">NMF-GCM (arXiv, 2024)</a>
    ...
    <div class="gallery-item">
      ...
      <div class="gallery-body">
        ...
        <ul>
          <li>回帰分析と一般化線形モデル</li>
          <li>成長曲線モデルと変化係数</li>
          <li>非負値行列因子分解(高校生用追加)</li>
          <li>生存時間解析</li>
        </ul>
        <p><a href="https://chatgpt.com/g/g-67f47ee647d081918d6c4888d33f425a-nmfzhi-wen-xiang">NMF質問箱</a> (shigauniversity-chatgpt-edu限定利用)</p>
      </div>
    </div>
    ...
    <div class="gallery-item">
      <img src="{{ 'image/c6790ae8cc2fa107162cd010b82cf433.jpg' | relative_url }}" alt="事例でわかる統計シリーズ 医療系のための統計入門">
      <div class="gallery-body">
        <h3>■事例でわかる統計シリーズ 医療系のための統計入門</h3>
        <div class="gallery-links">
          <a href="https://www.jikkyo.co.jp/book/detail/15500008/">実教出版社</a>
          <a href="https://www.amazon.co.jp/dp/4407337133/">Amazon</a>
        </div>
      </div>
    </div>
...
<div class="section">
  <h2 class="section-title">■滋賀県観光の周遊ネットワーク</h2>
...
<div class="section">
  ...
  <div class="card">
    <a href="{{ 'image/canada_temperature.gif' | relative_url }}"><img src="{{ 'image/76dbf4e89cd44e3bbb6f45655a0ebc80.jpg' | relative_url }}" alt="カナダの365日の気温変化" style="max-width: 100%; height: auto;"></a>
    <p>カナダの35観測地点における365日の日平均気温が，fdaパッケージの<a href="https://rdrr.io/cran/fda/man/CanadianWeather.html">CanadianWeather</a>として提供されている．観測地点の位置情報を用いた基底数2の非負値行列因子分解を適用することで，観測されていない地点における365日の気温を予測し，<a href="{{ 'image/canada_temperature.gif' | relative_url }}">GIFアニメーション</a>として示す．画像クリックでアニメが開始．</p>
  </div>
</div>
...
<div class="section">
  ...
  <div class="card">
    <a href="{{ 'image/hojo_ujimasa_kao.gif' | relative_url }}"><img src="{{ 'image/0e9b10e2e844555adf878d15b8f62f2d.jpg' | relative_url }}" alt="北条氏政の花押の経時変化" style="max-width: 100%; height: auto;"></a>
    <p><a href="https://wwwap.hi.u-tokyo.ac.jp/ships/w19/search">東京大学史料編纂所の花押データベース</a>から，北条氏政の1558年から1588年までの31年間96枚の花押画像を用いて基底数を3とする非負値行列因子分解を適用した．左に5つの基底画像によって近似・平滑化された花押を，右に元の花押画像を<a href="{{ 'image/hojo_ujimasa_kao.gif' | relative_url }}">GIFアニメーション</a>として示す．画像クリックでアニメが開始．初期において幅広だった花押が徐々に傾いていく様子が分かる．</p>
  </div>
</div>
